...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <a class="navbar-brand" href="#">MYKITS</a>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#logout', function() {
            showLoginPage();
            $('#response').html("<div class='alert alert-info'>คุณได้ออกจากระบบเรียบร้อยแล้ว.</div>");
        });
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title">You are logged in. (ตอนนี้คุณกำลังอยู่ในระบบ) </h5>
            <P ALIGN=CENTER class="animate__animated animate__fadeInDown"><a href='../indexmykits.php' class='btn btn-primary'>เข้าสู่หน้าเว็บไซต์</a> <P></P>
        </div>
    </div>
    `;
                ...
                .fail(function(result) {
                    showLoginPage();
                    $('#response').html(
                        "<div class='alert alert-danger'>กรุณาทำการล็อคอิน.</div>");
                });
        }
        ...
        <form id='update_account_form'>
            <div class="form-group">
                <label for="firstname">Firstname</label>
                <input type="text" class="form-control" name="firstname" id="firstname" required value="` + result.data
                        .firstname + `" />
            </div>
 
            <div class="form-group">
                <label for="lastname">Lastname</label>
                <input type="text" class="form-control" name="lastname" id="lastname" required value="` + result.data
                        .lastname + `" />
            </div>
 
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" name="email" id="email" required value="` + result.data
                        .email + `" />
            </div>
