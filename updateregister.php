<?php
    ...
    if(isset($_POST['updateus'])){
            ...
            $sql = $updatedata->updateus($iduser,$nameuser,$addressuser,$phoneuser,$idprefix,$idsex,$idposition,$userid);
          ...
          echo "<script>window.location.href='updateregister.php'</script>";
            }
    }
...
<body background="assets/img/back1.png">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>แก้ไข้ข้อมูล</h2>
            <p>Edit data</p>
            <a href="indexregister.php" class="btn btn-primary mt-3">GO BACK</a>
        </div>
        ...
        ?>
            <form action="" method="post" class="animate__animated animate__fadeInDown">

                <div class="mb-3">
                    <label for="iduser" class="form-label">ลำดับ</label>
                    <input type="text" class="form-control" name="iduser" value="<?php echo $row['iduser']; ?>"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nameuser" value="<?php echo $row['nameuser']; ?>"
                        required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="addressuser"
                        value="<?php echo $row['addressuser']; ?>" required>
                </div>

                <div class="mb-3">
                    <label for="phoneuser">เบอร์โทรผู้ใช้</label>
                    <input type="text" class="form-control" name="phoneuser" value="<?php echo $row['phoneuser']; ?>"
                        required>
                </div>
                ...
                <?php } ?>
                <P ALIGN=RIGHT><button type="submit" name="updateus" class="btn btn-success">Update</button></P>
            </form>
        </div>
    </div>
    <BR>
